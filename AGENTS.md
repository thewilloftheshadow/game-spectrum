...
- After completing and verifying requested changes, create signed Conventional Commits and push the full current branch by default, unless the user explicitly asks not to. Prefer focused commits and one push. Stop if signing fails; never bypass it.
